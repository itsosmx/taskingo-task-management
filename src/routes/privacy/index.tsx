...
export default function Privacy() {
  return (
    <Container>
      ...
      <p>
        At Taskingo, accessible from http://www.taskingo.osmx.me, one of our main priorities is the privacy of our
        visitors. This Privacy Policy document contains types of information that is collected and recorded by Taskingo
        and how we use it.
      </p>
      ...
      <p>
        ...
        to the information that they shared and/or collect in Taskingo. This policy is not applicable to any information
      ...
      <p>
        Taskingo follows a standard procedure of using log files. These files log visitors when they visit websites. All
      ...
      <p>You may consult this list to find the Privacy Policy for each of the advertising partners of Taskingo.</p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
        in their respective advertisements and links that appear on Taskingo, which are sent directly to users' browser.
      ...
      <p>Note that Taskingo has no access to or control over these cookies that are used by third-party advertisers.</p>

      <h2>Third Party Privacy Policies</h2>

      <p>
        Taskingo's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
      ...
      <p>
        Taskingo does not knowingly collect any Personal Identifiable Information from children under the age of 13. If
